...
export enum ErrorCode {
  ...
  // Content resolution errors (7xxx)
  CONTENT_PAYWALL = 7001,
  CONTENT_RATE_LIMITED = 7002,
  CONTENT_TIMEOUT = 7003,
  CONTENT_DNS_FAILURE = 7004,
  CONTENT_PDF_FAILED = 7005,
  CONTENT_EMPTY = 7006,
  CONTENT_HTML_STUB = 7007,

  // Discovery errors (8xxx)
  DISCOVERY_NOT_FOUND = 8001,
  DISCOVERY_NO_RESULTS = 8002,
  DISCOVERY_API_ERROR = 8003,
